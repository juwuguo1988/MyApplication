...
#include "com_example_hello_myapplication_utils_LameMp3Util.h"
#include <stdio.h>
#include <jni.h>
#include <stdio.h>
#include <stdlib.h>
...
JNIEXPORT jint Java_com_example_hello_myapplication_utils_LameMp3Util_encodeFile(JNIEnv *env,
