package com.example.hello.myapplication.utils.cardphoto.camera;

import android.app.Activity;
import android.content.Intent;
import android.support.v4.app.Fragment;

import com.example.hello.myapplication.activity.TakeUserCardPhotoActivity;
...
public class IDCardCamera {
    ...
    public final static int RESULT_CODE = 0x01;//结果码
    public final static int PERMISSION_CODE_FIRST = 0x02;//权限请求码
    ...
    public void openCamera(int IDCardDirection) {
        ...
        Intent intent = new Intent(activity, TakeUserCardPhotoActivity.class);
