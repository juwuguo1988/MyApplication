...
import com.example.hello.myapplication.utils.cardphoto.camera.AutoFocusManager;
import com.example.hello.myapplication.utils.cardphoto.camera.SensorControler;
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (camera != null) {
            try {
                ...
                Camera.Size bestSize = getOptimalPreviewSize(sizeList, XZLApplication.horizontalScreenWidth, XZLApplication.horizontalScreenHeight);
